...
public class FirebaseArrayMatt<T> implements ChildEventListener, ValueEventListener{
    ...
    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
        ...
        ///Si se recibe una ubicacion, se añade esa distancia, de otro modo
        /// las distancias se quedan con valor 0, e indistintos al ordenar
    ...
    public List<T> getDatos(){
        if(!filtrando)
            return arrayClassGen;
        else
            return arrayFilterClassGen;
    }
